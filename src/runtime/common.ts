...
export type Manifest={kind:"sd-turbo"|"longlive";width:number;height:number;latentScale:number;models:Record<string,string>;io?:Record<string,string>;scheduler?:{trainSteps:number}};
